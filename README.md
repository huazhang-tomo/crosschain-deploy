...
```bash
$ cd crosschain-tasks
$ sudo docker run --rm -it --entrypoint npx -v $(pwd)/config.prod.yaml:/app/config.prod.yaml 133735975201.dkr.ecr.us-east-1.amazonaws.com/dev/fanstech/crosschain-core:dev-v2-20250711-0919-c838c8f@sha256:a8a100edcb033449148ba5ce99614ab09189c94924a3bf67f19cd330bdd02cf8
